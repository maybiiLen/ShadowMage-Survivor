...
const UPGRADES = {
	"shadowspear1": {
		...
		"details": "A spear of shadowflame is thrown at a random enemy",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"shadowspear2": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Shadow Spear",
		"details": "An addition Shadow Spear is thrown",
		"level": "Level: 2",
	...
	"shadowspear3": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Shadow Spear",
		"details": "Shadow Spears now pass through another enemy and do + 3 damage",
		"level": "Level: 3",
		"prerequisite": ["shadowspear2"],
		"type": "weapon"
	},
	"shadowspear4": {
		"icon": WEAPON_PATH + "ice_spear.png",
		"displayname": "Shadow Spear",
		"details": "An additional 2 Shadow Spears are thrown",
		"level": "Level: 4",
		"prerequisite": ["shadowspear3"],
		"type": "weapon"
	},
	"javelin1": {
